...
def test_get_email_false_use_test_email():
    # update fake use_test_email in app settings
    app_settings = {
...
def test_get_email_valid_employee_email():
    # update fake use_test_email in app settings
...
def test_get_email_blank_employee_email():
    # update fake use_test_email in app settings
...
def test_get_email_valid_email():
    # update fake use_test_email in app settings
    app_settings = {"use_test_email": False, "degreed_test_email": ""}
    # update fake use_test_email in request data
...
def test_get_email_valid_current_user_email():
    # update fake use_test_email in app settings
    app_settings = {"use_test_email": False, "degreed_test_email": ""}
    # update fake use_test_email in request data
